...
| Item | Purpose |
|---|---|
| `AI Business Value Dashboard - Sharepoint Path.pbip` | Power BI project (NatWest pre-parsed format). Open in Power BI Desktop, fill in parameters, publish to Service. |
