...
1. Open **[`../1. SharePoint/ValueLens - SharePoint (Local CSV).pbit`](../1.%20SharePoint/)** in Power BI Desktop.
...
> Use the **(Local CSV)** template, not the plain `ValueLens - SharePoint.pbit`. The
> latter deliberately accepts SharePoint URLs only.
...
[`../1. SharePoint/scripts/Purview_CopilotInteraction_Processor_v4.0.0.py`](../1.%20SharePoint/scripts/).
